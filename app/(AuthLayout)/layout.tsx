...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-background">
      ...
      <div className="flex flex-col justify-center items-center px-8 py-12 lg:px-20">
        <div className="w-full max-w-md space-y-8">
          ...
          <Link href="/" className="flex items-center gap-2 mb-10">
            <div className="h-10 w-10 bg-orange-600 rounded-xl flex items-center justify-center text-white font-black text-xl">
              F
            </div>
            <span className="text-2xl font-black tracking-tighter text-foreground">FoodHub</span>
          </Link>
      ...
      <div className="hidden lg:block relative bg-slate-950 overflow-hidden border-l border-border">
        <Image 
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-16 bg-gradient-to-t from-black/80 to-transparent">
          ...
          <p className="text-slate-300 font-medium">Join thousands of foodies in Dhaka.</p>
        </div>
      </div>
    </div>
  );
