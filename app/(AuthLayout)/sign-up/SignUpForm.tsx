  ...
  return (
    <div className="w-full space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="space-y-2 text-center lg:text-left">
        ...
        <p className="text-muted-foreground font-semibold">Join FoodHub today.</p>
      </div>
        ...
        <form.Field name="role">
          {(field) => (
            <div className="space-y-2">
              <Label className="text-sm font-bold text-foreground ml-1">I want to...</Label>
                ...
                <button
                  ...
                  className={`flex items-center justify-center gap-2 h-12 rounded-xl border-2 transition-all font-bold text-sm ${
                    field.state.value === "CUSTOMER"
                      ? "border-orange-600 bg-orange-500/10 text-orange-600 shadow-sm"
                      : "border-border bg-muted/50 text-muted-foreground hover:border-orange-600/30"
                  }`}
                >
            ...
            <div className="space-y-1">
              ...
              <div className="relative flex items-center">
                ...
                <Input
                  ...
                  className="pl-12 h-12 w-full rounded-xl border-border bg-background focus:ring-2 focus:ring-orange-500 outline-none transition-all"
                />
              </div>
            </div>
          )}
        ...
        <form.Subscribe selector={(state) => [state.canSubmit, state.isSubmitting]}>
          {([canSubmit, isSubmitting]) => (
            <Button
              type="submit"
              disabled={!canSubmit}
              className="w-full h-12 rounded-xl bg-foreground text-background hover:bg-orange-600 hover:text-white font-black transition-all shadow-lg active:scale-95 mt-2"
            >
