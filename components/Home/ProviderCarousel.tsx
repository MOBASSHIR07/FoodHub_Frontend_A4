    ...
    <div className="relative group">
      ...
      >
        {providers.map((provider) => (
          ...
          >
            <div className="h-full bg-card rounded-[2.5rem] border border-border overflow-hidden hover:shadow-2xl hover:shadow-orange-500/10 transition-all duration-500 flex flex-col">
              
              {/* Image Section with Logic for Nulls */}
              <div className="relative h-52 w-full bg-orange-500/5 overflow-hidden">
                {provider.coverImage ? (
                  <Image
                ...
                <div className="absolute top-5 right-5 bg-background/90 backdrop-blur-md px-3 py-1.5 rounded-2xl flex items-center gap-1.5 shadow-sm border border-border">
              ...
              <div className="p-7 flex-grow flex flex-col justify-between space-y-4">
                ...
                <div className="pt-4 border-t border-border flex items-center justify-between">
                  <div className="flex flex-col">
                    <span className="text-[10px] uppercase font-black text-muted-foreground tracking-widest">Menu Items</span>
                    <span className="text-sm font-black text-foreground">
                      {provider._count?.meals || 0} Delicious Meals
                    </span>
                  </div>
                  <div className="h-10 w-10 rounded-full bg-orange-500/10 flex items-center justify-center group-hover/card:bg-orange-600 group-hover:text-white transition-all">
